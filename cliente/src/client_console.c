...
void mostrarComandosValidos(char *modulo) {
	...
	if (modulo) {
		...
		printf("Formato: \033[1;34m[MODULO]\033[0m \033[1;33m[MENSAJE]\033[0m [PARAMETROS] ~~旦_(･o･;)\n");
		switch (proceso) {
			case OPTION_APP:
				printf("\033[0;34mAPP\033[0m \033[0;33mCONSULTAR_RESTAURANTES\033[0m\n");
				printf("\033[0;34mAPP\033[0m \033[0;33mSELECCIONAR_RESTAURANTE\033[0m [NOMBRE_CLIENTE] [NOMBRE_RESTAURANTE]\n");
				printf("\033[0;34mAPP\033[0m \033[0;33mCONSULTAR_PLATOS\033[0m [NOMBRE_RESTAURANTE]\n");
				printf("\033[0;34mAPP\033[0m \033[0;33mCREAR_PEDIDO\033[0m\n");
				printf("\033[0;34mAPP\033[0m \033[0;33mANIADIR_PLATO\033[0m [NOMBRE_PLATO] [ID_PEDIDO]\n");
				printf("\033[0;34mAPP\033[0m \033[0;33mCONFIRMAR_PEDIDO\033[0m [ID_PEDIDO]\n");
				printf("\033[0;34mAPP\033[0m \033[0;33mPLATO_LISTO\033[0m [NOMBRE_RESTAURANTE] [ID_PEDIDO] [NOMBRE_COMIDA]\n");
				printf("\033[0;34mAPP\033[0m \033[0;33mCONSULTAR_PEDIDO\033[0m [ID_PEDIDO]\n");
				break;
			case OPTION_COMANDA:
				printf("\033[0;34mCOMANDA\033[0m \033[0;33mGUARDAR_PEDIDO\033[0m [NOMBRE_RESTAURANTE] [ID_PEDIDO]\n");
				printf("\033[0;34mCOMANDA\033[0m \033[0;33mGUARDAR_PLATO\033[0m [NOMBRE_RESTAURANTE] [ID_PEDIDO] [NOMBRE_COMIDA] [CANTIDAD]\n");
				printf("\033[0;34mCOMANDA\033[0m \033[0;33mCONFIRMAR_PEDIDO\033[0m [ID_PEDIDO] [NOMBRE_RESTAURANTE]\n");
				printf("\033[0;34mCOMANDA\033[0m \033[0;33mPLATO_LISTO\033[0m [NOMBRE_RESTAURANTE] [ID_PEDIDO] [NOMBRE_COMIDA]\n");
				printf("\033[0;34mCOMANDA\033[0m \033[0;33mOBTENER_PEDIDO\033[0m [NOMBRE_RESTAURANTE] [ID_PEDIDO]\n");
				break;
			case OPTION_RESTAURANTE:
				printf("\033[0;34mRESTAURANTE\033[0m \033[0;33mCONSULTAR_PLATOS\033[0m [NOMBRE_RESTAURANTE]\n");
				printf("\033[0;34mRESTAURANTE\033[0m \033[0;33mCREAR_PEDIDO\033[0m\n");
				printf("\033[0;34mRESTAURANTE\033[0m \033[0;33mANIADIR_PLATO\033[0m [NOMBRE_PLATO] [ID_PEDIDO]\n");
				printf("\033[0;34mRESTAURANTE\033[0m \033[0;33mCONFIRMAR PEDIDO\033[0m [ID_PEDIDO] \n");
				printf("\033[0;34mRESTAURANTE\033[0m \033[0;33mCONSULTAR_PEDIDO\033[0m [ID_PEDIDO]\n");
				break;
			case OPTION_SINDICATO:
				printf("\033[0;34mSINDICATO\033[0m \033[0;33mOBTENER_RESTAURANTE\033[0m [NOMBRE_RESTAURANTE]\n");
				printf("\033[0;34mSINDICATO\033[0m \033[0;33mCONSULTAR_PLATOS\033[0m [NOMBRE_RESTAURANTE]\n");
				printf("\033[0;34mSINDICATO\033[0m \033[0;33mGUARDAR_PEDIDO\033[0m [NOMBRE_RESTAURANTE] [ID_PEDIDO]\n");
				printf("\033[0;34mSINDICATO\033[0m \033[0;33mGUARDAR_PLATO\033[0m [NOMBRE_RESTAURANTE] [ID_PEDIDO] [NOMBRE_COMIDA] [CANTIDAD]\n");
				printf("\033[0;34mSINDICATO\033[0m \033[0;33mCONFIRMAR_PEDIDO\033[0m [ID_PEDIDO] [NOMBRE_RESTAURANTE]\n");
				printf("\033[0;34mSINDICATO\033[0m \033[0;33mPLATO_LISTO\033[0m [NOMBRE_RESTAURANTE] [ID_PEDIDO] [NOMBRE_COMIDA]\n");
				printf("\033[0;34mSINDICATO\033[0m \033[0;33mOBTENER_PEDIDO\033[0m [NOMBRE_RESTAURANTE] [ID_PEDIDO]\n");
				break;
			default:
				mensajesValidos();
				break;
